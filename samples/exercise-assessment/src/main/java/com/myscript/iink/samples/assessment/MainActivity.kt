...
class MainActivity : AppCompatActivity(), IEditorListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        MyIInkApplication.getEngine()?.createPackage(IINK_PACKAGE_NAME)?.let { contentPackage ->
            ...
            findViewById<View>(R.id.problemSolver1).findViewById<EditorView>(com.myscript.iink.uireferenceimplementation.R.id.editor_view)?.let { answerEditorView ->
                answerEditorView1 = answerEditorView
                initWith(answerEditorView, contentPackage,"Math","standard")
            }

            findViewById<View>(R.id.problemSolver2).findViewById<EditorView>(com.myscript.iink.uireferenceimplementation.R.id.editor_view)?.let { answerEditorView ->
                answerEditorView2 = answerEditorView
                initWith(answerEditorView, contentPackage,"Math","standardK8")
            }

            findViewById<View>(R.id.problemSolver3).findViewById<EditorView>(com.myscript.iink.uireferenceimplementation.R.id.editor_view)?.let { answerEditorView ->
                answerEditorView3 = answerEditorView
                initWith(answerEditorView, contentPackage,"Text")
            }

            findViewById<View>(R.id.problemSolver4).findViewById<EditorView>(com.myscript.iink.uireferenceimplementation.R.id.editor_view)?.let { answerEditorView ->
                answerEditorView4 = answerEditorView
                initWith(answerEditorView, contentPackage,"Diagram")
            }

            findViewById<View>(R.id.problemSolver5).findViewById<EditorView>(com.myscript.iink.uireferenceimplementation.R.id.editor_view)?.let { answerEditorView ->
